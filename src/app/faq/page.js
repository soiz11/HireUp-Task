...
const FaqContent = () => {
  ...
  const filteredArray = faqs.filter((q) => q.question.startsWith(inputValue));
  ...
  return (
    <div className="flex relative flex-col gap-y-8 items-center justify-center w-full min-h-screen bg-gradient-radial from-white to-indigo-500">
      ...
      <div
        className="absolute bottom-[15%] 2xl:right-[20%] right-[5%] bg-white rounded-md p-2 shadow-custom size-[50px] flex items-center justify-center"
